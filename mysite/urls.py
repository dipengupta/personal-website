...
urlpatterns = [
	...
	re_path(r'^music/ipod/$', views.displayIpodPage, name='ipod-page'),
	...
	re_path(r'explore/', views.displayTravelsPage, name='explore-page'),
	re_path(r'travels/', views.displayTravelsPage, name='travels-page'),
